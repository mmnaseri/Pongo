...
class Rediska_Command_Sort extends Rediska_Command_Abstract {
	...
	protected $_options = array('order' => self::ASC, 'limit' => null, 'offset' => null, 'alpha' => false, 'by' => null, 'get' => null, 'store' => null,);
	...
	public function create($key, array $options = array()) {
		...
		$command = array('SORT', $this->_rediska->getOption('namespace') . $key);
