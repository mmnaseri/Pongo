...
class Rediska_Connection extends Rediska_Options {
	 ...
	 * @var array
	 */
	protected $_options = array('host' => self::DEFAULT_HOST, 'port' => self::DEFAULT_PORT, 'db' => self::DEFAULT_DB, 'alias' => null, 'weight' => self::DEFAULT_WEIGHT, 'password' => null, 'persistent' => false, 'timeout' => null, 'readTimeout' => null, 'blockingMode' => true, 'streamContext' => null,);
	...
	public function connect() {
		if (!$this->isConnected()) {
			...
			$socketParams = array($socketAddress, &$errno, &$errmsg, $this->getTimeout(), $flag);
